...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:-3000px" id="mySidebar"><br>
...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:0px; width:200px">
